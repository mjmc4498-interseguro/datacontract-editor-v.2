...
import { DEFAULT_AI_CONFIG, resolveAiConfig } from '../config/defaults.js';
...
function getProvider(config) {
  ...
  // 'openai', 'openrouter', or any other OpenAI-compatible API
  // (Azure OpenAI, Ollama, vLLM, LiteLLM, ...) all use the OpenAI adapter.
...
export async function streamChatCompletion({
  ...
  const mergedConfig = resolveAiConfig({ ...DEFAULT_AI_CONFIG, ...config });
