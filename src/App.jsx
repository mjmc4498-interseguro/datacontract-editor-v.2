    ...
    useEffect(() => {
        ...
        if (encodedData) {
            try {
                ...
                alert(es.app.sharedLinkInvalid);
            }
        }
    }, [setYaml]);
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-lg">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <h1 className="text-lg font-bold text-red-800">{es.app.applicationError}</h1>
                                <p className="mt-2 text-sm text-red-700">
                                    {es.app.criticalError(APP_DISPLAY_NAME)}
                                </p>
                                <div className="mt-3 text-sm text-red-600">
                                    <span className="font-medium">{es.common.error}: </span>
                                    {error?.message || es.common.unknownError}
                                </div>
