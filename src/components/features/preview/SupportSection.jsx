	...
	return (
		<li className="relative flex items-start gap-x-4 px-4 py-3 sm:px-6">
			...
			<div className="flex-1 flex flex-wrap gap-x-6">
				{channel.tool && (
					<div className="flex items-center gap-x-4">
						<div className="flex flex-col">
							<dt className="text-sm font-medium text-gray-500">{es.common.tool}</dt>
				...
				<div className="flex items-center gap-x-4">
					<div className="flex flex-col">
						<dt className="text-sm font-medium text-gray-500">{es.preview.channel}</dt>
				...
				{channel.scope && (
					<div className="flex items-center gap-x-4">
						<div className="flex flex-col">
							<dt className="text-sm font-medium text-gray-500">{es.preview.scope}</dt>
				...
				{channel.invitationUrl && (
					<div className="flex items-center gap-x-4">
						<div className="flex flex-col">
							<dt className="text-sm font-medium text-gray-500">{es.preview.invitationUrl}</dt>
							<dd className="mt-1 text-sm text-gray-900">
								<a href={channel.invitationUrl} target="_blank" rel="noopener noreferrer"
								   className="text-indigo-600 hover:text-indigo-500">
									{es.preview.invitationLink}
								</a>
							</dd>
						</div>
					</div>
	...
	return (
		<section>
			<div className="px-4 sm:px-0">
				<h1 className="text-base font-semibold leading-6 text-gray-900" id="support">{es.preview.supportChannelsTitle}</h1>
				<p className="text-sm text-gray-500">{es.preview.supportChannelsSubtitle}</p>
			</div>
			<ul role="list"
